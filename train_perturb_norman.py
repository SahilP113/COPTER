...
from train_utils_perturb_norman import train_val_test
from metrics.metrics_utils_perturb import calculate_mse20, save_results
from data_prep.data_prep_norman import get_all_data
...
def run_finetune(gene_aa_dict, train_genes, train_controls, train_y, train_de_idxs, val_genes, val_controls, val_y, val_de_idxs, test_genes, test_controls, test_y, test_de_idxs, models_output_dir, plm_type, embed_name, embed_name2, hparams, batch_size, num_epoch, weigh_sample, weigh_loss):
    ...
    test_metrics = train_val_test(gene_aa_dict, train_loader, val_loader, test_loader, plm_type, models_output_dir, embed_name, embed_name2, num_epoch, batch_size, weigh_sample, weigh_loss, hparams)
...
def run_all(args, hparams, wandb):
    ...
    task_folder = "data/gene_perturb_data/norman"
    splits_file = "norman_simulation_1_0.75.pkl"
    ...
    gene_aa_dict, train_genes, train_controls, train_y, train_de_idxs, val_genes, val_controls, val_y, val_de_idxs, test_genes, test_controls, test_y, test_de_idxs = get_all_data(data_file_path, gene_ens_path, ensembl_aa_path, splits_file_path)

    data_split_path = args.data_split_path + ".json"

    test_metrics = run_finetune(gene_aa_dict, train_genes, train_controls, train_y, train_de_idxs, val_genes, val_controls, val_y, val_de_idxs, test_genes, test_controls, test_y, test_de_idxs, models_output_dir, args.plm, args.embed, args.embed2, hparams, args.batch_size, args.num_epoch, args.weigh_sample, args.weigh_loss)
