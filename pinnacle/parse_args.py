...
def get_args():
    ...
    # Input
    parser.add_argument("--G_f", type=str, default="../raw_data/networks/global_ppi_edgelist.txt/", help="Directory to global reference PPI network")
    parser.add_argument("--ppi_dir", type=str, default="../raw_data/networks/ppi_edgelists/", help="Directory to PPI layers")
    parser.add_argument("--mg_f", type=str, default="../raw_data/networks/mg_edgelist.txt", help="Directory to metagraph")
    ...
    parser.add_argument("--output", type=int, default=8, help="Output size") #Change this to 8000   change self.reference=cell-emb.view
