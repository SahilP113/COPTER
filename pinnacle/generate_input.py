...
def read_data(G_f, ppi_dir, mg_f, feat_mat_dim):
    ...
    #print(ppi_layers)
    mg_mapping = {n: i for i, n in enumerate(sorted(ppi_layers))}  #The n[8:] removes the "cluster:" prefix in front of each cell type name
    ...
    #for n in metagraph.to_undirected().neighbors("BTO:0001129"):
        #print(n) 
