...
wandb.init(config = hparams_raw, project = "pinnacle", entity = "sahilp113-duke-university") #entity="user"
...
def train(epoch, model, optimizer, center_loss):
    ...
    #The model is being set to train mode but it doesn't appear to be called anywhere
    model.train()
...
def main():
    ...
    #Should I include the center loss when optimizing also?
