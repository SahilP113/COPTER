...
class MLP(nn.Module):
    def __init__(self, in_dim: int, hidden_dims: list, final_dim: int, p: float, norm: str, actn: str, order: str = 'nd'):
        ...
        # Output layers
        layers.append(nn.Linear(hidden_dims[-1], self.final_dim))
