...
class SWE_Pooling(nn.Module):
    def __init__(self, d_in, num_slices, num_ref_points, d_cell, freeze_swe=False):
        '''
        ...
        self.d_cell = d_cell
        self.proj = nn.Linear(d_cell, num_slices*num_ref_points, bias=False)
    ...
    def forward(self, X, C, mask):
        ...
        if mask is None:
            ...
            #print("Mask Shape: ", invalid_elements_mask.shape)
        ...
        Rslices = self.proj(C).reshape(B, M, L)
        #print("Rslices shape: ", Rslices.shape)
        ...
        return weighted_embeddings.view(-1, self.num_slices), Rslices  
